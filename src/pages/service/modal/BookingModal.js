        ...
        <div className="h-[700px] w-full">
          <div className="grid grid-cols-1 snap-y gap-4 sm:gap-0 sm:grid-cols-2 relative  shadow-ButtonShadow w-[90%] lg:w-[800px] mx-auto h-full">
            <label
              ...
              className=" text-[black] btn-circle absolute right-4 top-4 text-[30px]"
            >
              ✕
            </label>
            <div className="overflow-hidden">
              <img
                className="w-[280px] mx-auto sm:w-full h-[540px]  sm:h-full"
                src={imageURLs[0]}
                alt=""
              />
            </div>
            <div className="overflow-hidden w-[280px] mx-auto sm:w-full h-[540px] flex justify-center items-center py-10 px-2 sm:px-4 sm:h-full  bg-white">
              <div className="">
                ...
                <div className="flex items-center pt-6 pb-2 gap-4">
                  <div className="border py-[6px] px-10 text-[#262626] grid grid-cols-3 gap-4 items-center w-[140px] font-Arimo font-semibold border-[#bebbbb] ">
                    {" "}
                    <a
                      className="text-[30px]"
                      onClick={() => {
                  ...
                  <Link>
                    ...
                    <button
                      onClick={AddTocart}
                      className="py-2 px-10 hover:bg-[#064532] bg-[#262626] ease-linear  duration-200 font-Arimo font-semibold text-white"
                    >
                      ADD TO CART
                    </button>
                  </Link>
                ...
                <div className="text-center mx-auto py-2">
                  <button className="py-2 px-10 bg-[#064532] hover:bg-[#262626] ease-linear duration-200  text-[15px] font-Arimo w-[90%] font-semibold text-white">
                    BUY NOW
                  </button>
                </div>
              </div>
